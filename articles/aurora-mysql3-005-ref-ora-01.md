...
- 安全に進めるために、修正を Aurora アップグレードと同時にリリースするのではなく、**事前に（必要に応じて何度かに分けて）リリースしておく**
...
例えば、以前紹介した **[サイボウズのブログ記事](https://blog.cybozu.io/entry/2021/05/24/175000#SQL_CALC_FOUND_ROWS-%E3%81%A8-FOUND_ROWS-%E3%81%8C-deprecated-%E3%81%AB)** でも、現時点の MySQL 8.0 で非推奨かつ未削除の`SQL_CALC_FOUND_ROWS`・`FOUND_ROWS()`が取り上げられていました。
